        ...
        <div className="flex flex-col gap-3">
          ...
          <div>
            ...
            <ol className="list-decimal ml-6">
              <li>
                ...
                residentes descubran y disfruten de todo lo que Mendoza tiene
                para ofrecer.
              </li>
              <li>
          ...
          <div>
            ...
            <ol className="list-decimal ml-6">
              <li>
                ...
                responsable por ninguna pérdida o daño que surja del uso del
                sitio web, incluidos, pero no limitados a, daños directos,
                indirectos, incidentales, punitivos y consecuentes.
              </li>
              <li>
                <b>Estafas y Falsa Información:</b> No nos hacemos responsables
                por estafas, fraudes o cualquier otra actividad engañosa que
                pueda ocurrir debido a la información proporcionada por los
                usuarios en nuestro sitio web. Los usuarios deben realizar sus
                propias investigaciones y tomar precauciones al interactuar con
                otros usuarios o utilizar la información disponible en el sitio.
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <ol className="list-decimal ml-6">
              ...
              <li>
                ...
                licencia no incluye la reventa o el uso comercial del sitio web
                o su contenido.
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              vigor inmediatamente después de su publicación en el sitio web. Es
              tu responsabilidad revisar regularmente estos términos para estar
          ...
          <div>
            ...
            <p>
              Para obtener información sobre cómo recopilamos, usamos y
              protegemos tu información personal, por favor revisa nuestra
          ...
          <div>
            ...
            <p>
              ...
              con las leyes de Argentina. Cualquier disputa que surja en
              relación con estos términos se someterá a la jurisdicción
              exclusiva de los tribunales de Mendoza.
            </p>
          </div>
